...
*/
	...
	this.mostrar = function (){
		return (this.imagen + "<b>" + "Nombre: " + "</b>" + this.nombre + "<br>" + "<b>" + "Edad: " +  "</b>"  + this.edad + " años" + "<br>" + "<b>" +  "Hobbies: " + "</b>" + "<ul>" + this.lista() +"</ul>" + '<textarea name="comentario" rows="5" cols="40">Escribe tu comentario....</textarea>' + '<button type="button" onclick="imprimir()">Comentar</button>' +"<br>")
	}
}
...
var pez = new Squad("María Paz Rojas", 26, ["Música","Comer", "Hablar ingles"], "<img src='http://aquariumplants.club/wp-content/uploads/imported/Betta-Splendens-Siamese-Fighting-Fish-Red-Male-Live-Tropical-Aquarium-Fish-B0194NOSQA-3-400x400.jpg' alt='imagen'>",[]);
...
function imprimir(){
		/*var comentario = document.getElementsByTagName("textarea").value;
		 //*Queria que cada comentario se pusheara en el array comentarios de los objetos
		personas.forEach(function(el){
			return el.comentarios.push(comentario);
		})
		var textos = [];
		textos.push(comentario);
		return textos;
		//*textoComent.innerHTML = textos; //* No resulto no guarda nada */

		alert("Era bromi no funciona");
	}